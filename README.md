...
| **Power User Statistics** | Live ms-error/EX/calorie stats or a streamlined judgement-count readout, as a side column or a bottom line; pacemaker→ms-error swap, CSV step export. |
