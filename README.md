...
| **DDR SELECTION** | A3's legacy gameplay skins per player (OFF / AUTO / 1st-5th / MAX-EXTREME / SuperNOVA / X / 2013-A), from the stock install's own legacy data. In progress, default off. |
