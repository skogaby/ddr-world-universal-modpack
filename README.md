...
One file the 2013-A skin's combo counter will need is blank in World's data (`dance_combo0005_v0.arc`). If you also have a DDR A3 install, copy it over once — from the game folder:
