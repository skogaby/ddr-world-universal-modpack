...
# cabinet-validated).
declare -a MODULE_NAMES=(scene3d_pure scene3d_render_item_layout scene3d_node_layout scene3d_frame_board scene3d_camera_math scene3d_viewport_pass_layout anm selection schedule director_math clock tempo outline catalog pick instance_plan preview_layout preview_state custom_content movie_mode)
