...
# cabinet-validated).
declare -a MODULE_NAMES=(scene3d_pure scene3d_render_item_layout scene3d_node_layout scene3d_frame_board anm selection schedule director_math clock tempo)
